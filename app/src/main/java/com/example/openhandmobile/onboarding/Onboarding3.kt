...
@Composable
fun Onboarding3(nav: NavHostController, modifier: Modifier = Modifier) {
    LaunchedEffect(Unit) {
        delay(1000)
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.skill_transparent),
            ...
            )
            {
                OutlinedButton(
                    onClick = {
                        ...
                        OnboardingState.setSkill("beginner")
                ...
                OutlinedButton(
                    onClick = {
                        SoundManager.play("click")
                        OnboardingState.setSkill("intermediate")
                        nav.navigate("onboarding4")
                    },
                    modifier = Modifier.fillMaxWidth()
                        .padding(horizontal = 20.dp),
                ...
                OutlinedButton(
                    onClick = {
                        SoundManager.play("click")
                        OnboardingState.setSkill("advanced")
                        nav.navigate("onboarding4")
                    },
                    modifier = Modifier.fillMaxWidth()
                        .padding(horizontal = 20.dp),
                ...
                OutlinedButton(
                    onClick = {
                        SoundManager.play("click")
                        OnboardingState.setSkill("expert")
                        nav.navigate("onboarding4")
                    },
                    modifier = Modifier.fillMaxWidth()
                        .padding(horizontal = 20.dp),
