...
@Composable
fun Onboarding2_5(nav: NavHostController, modifier: Modifier = Modifier) {
    LaunchedEffect(Unit) {
        delay(1000)
        SoundManager.play("questions")
    }
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.questions_transparent),
